  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Icon halo */}
        <div className="relative mx-auto mb-3 w-12 h-12 flex items-center justify-center rounded-xl transition-all duration-300"
        ...
        {/* Bottom accent */}
        <div className="absolute bottom-0 left-0 right-0 h-px scale-x-0 group-hover:scale-x-100 transition-transform duration-400 origin-center"
...
/* ─────────────────────────────────────────────
   Feature Card
───────────────────────────────────────────── */
const FeatureCard: React.FC<{ feature: any; index: number; inView: boolean }> = ({ feature, index, inView }) => {
  const [hov, setHov] = useState(false)
  return (
    <motion.div
          ...
          >
            ...
            <h2 className="font-black tracking-tight mb-5 leading-none"
              ...
              <span className="text-transparent bg-clip-text animate-gradient"
                style={{ backgroundImage: 'linear-gradient(135deg,#f472b6,#a78bfa,#22d3ee)', backgroundSize: '200% 200%' }}>
                Shaadi Tree
              </span>
            </h2>
